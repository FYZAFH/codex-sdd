...
grep -q "agent_type: spec-document-reviewer" "${TMP_DIR}/codex/.agents/skills/brainstorming/SKILL.md"
...
grep -q "spawn_agent" "${TMP_DIR}/codex/.agents/skills/brainstorming/SKILL.md"
...
grep -Fq "path = \"${TMP_DIR}/codex/.agents/skills/brainstorming/SKILL.md\"" "${TMP_DIR}/codex/.codex/agents/implementer.toml"
